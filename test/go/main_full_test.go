...
import (
	...
	localFile "github.com/cdktf/cdktf-provider-local-go/local/v5/file"
	localProvider "github.com/cdktf/cdktf-provider-local-go/local/v5/provider"
	randomProvider "github.com/cdktf/cdktf-provider-random-go/random/v5/provider"
	"github.com/cdktf/cdktf-provider-random-go/random/v5/stringresource"
