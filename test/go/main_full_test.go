...
import (
	...
	localFile "github.com/cdktf/cdktf-provider-local-go/local/v6/file"
	localProvider "github.com/cdktf/cdktf-provider-local-go/local/v6/provider"
	randomProvider "github.com/cdktf/cdktf-provider-random-go/random/v7/provider"
	"github.com/cdktf/cdktf-provider-random-go/random/v7/stringresource"
